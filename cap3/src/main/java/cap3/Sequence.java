...
public class Sequence {
	...
	public int get(int _idx){
		System.out.println("array size is "+arrSeq.length);
		System.out.println("first arg is"+ (_idx/UNITLEN));
		System.out.println("index is"+ _idx);
		return ((arrSeq[Math.abs(_idx/UNITLEN)]>>(_idx%UNITLEN)*3)&MASK);
	}
